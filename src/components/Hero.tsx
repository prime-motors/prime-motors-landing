...
export default function Hero() {
  ...
  return (
    <ParallaxBackground
      ...
      overlayClassName="bg-gradient-to-b from-[rgba(12,11,6,0.85)] via-[rgba(12,11,6,0.50)] to-[rgba(12,11,6,0.70)]
                        dark:from-[rgba(12,11,6,0.85)] dark:via-[rgba(12,11,6,0.50)] dark:to-[rgba(12,11,6,0.70)]
                        light:from-[rgba(254,252,232,0.88)] light:via-[rgba(254,252,232,0.55)] light:to-[rgba(254,252,232,0.75)]"
    >
